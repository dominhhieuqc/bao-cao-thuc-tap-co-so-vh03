...
<html>
    ...
    <body> 
        ...
        <div class="container">
            ...
            <div class="tm-container-inner tm-featured-image" style="margin-top: 20px; margin-bottom: 20px;">
    <div class="row">
        <div class="col-12">
            <div style="
                background-image: url('img/nhahang1.jpg');
        ...
        <script type="text/javascript">
            ...
            function overtime() {
                ...
                if (hour < 4 || hour >= 24) {
                    if (confirm("We only sell from 4:00 to 24:00, please comeback in time!")) {
                        window.location = "cart";
                    }
                }
            }
